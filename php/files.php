    ...
    try {
        ...
        if ($data->img != ''){
                ...
                if ($result){
                    ...
                    $user = new User();
                    $user->updateProfilePic($data->customerid);
                    $this->responseData = json_encode(array("result"=>true, "message"=>"Your pic was submitted!"));
                } else {
                    $this->strErrorDesc = 'Picture could no be updated at the moment. Please try again later';
            ...
            $this->strErrorDesc = 'No Picture Found.';
            $this->strErrorHeader = 'HTTP/1.1 500 Internal Server Error';
        }
    } catch (Error $e) {
