...
const logCheck = () => {
    ...
    if (xx == ''){
       ...
       normalView;
        ...
        $(".log-link").toggleClass('d-none');
    }
}


const normalView = () => {
    //link view for non-logged users
    $(".admin-links").addClass('d-none');
    $(".log-link")[0].removeClass('d-none');
    $(".log-link")[1].addClass('d-none');
}
